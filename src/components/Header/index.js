        ...
        <div className="row">
          <section id="home-section" className="page-section col">
            ...
            <div className="home-contact-info">
              <label id="phone-number" className="contact-info">Phone: 0406 253 030 || </label>
              <label id="email-address" className="contact-info">Email: tmhaigh@gmail.com || </label>
              <label className="contact-info">Location: Melbourne, Victoria, Australia</label>
            </div>
